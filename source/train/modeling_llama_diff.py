...
# Copied from transformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->DiffLlama
...
# Copied from transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->DiffLlama
...
def lambda_init_fn(layer_idx: int):
...
# This model is not support Flash-Attention
DIFFLLAMA_ATTENTION_CLASSES = {
    "eager": DiffLlamaAttention,
}


# Copied from transformers.models.llama.modeling_llama.LlamaDecoderLayer with LLAMA->DIFFLLAMA,Llama->DiffLlama
...
# Copied from transformers.models.llama.modeling_llama.LlamaPreTrainedModel with Llama->DiffLlama
...
# Copied from transformers.models.llama.modeling_llama.LlamaModel with LLAMA->DIFFLLAMA,Llama->DiffLlama
...
# Copied from transformers.models.llama.modeling_llama.LlamaForSequenceClassification with LLAMA->DIFFLLAMA,Llama->DiffLlama
...
# Copied from transformers.models.llama.modeling_llama.LlamaForQuestionAnswering with LLAMA->DIFFLLAMA,Llama->DiffLlama
...
# Copied from transformers.models.llama.modeling_llama.LlamaForTokenClassification with LLAMA->DIFFLLAMA,Llama->DiffLlama
